...
import pandas as pd
from scene_trajectory_benchmark.datastructures import PointCloud, SE3, SE2, RGBImage, CameraModel, CameraProjection
import numpy as np
...
class WaymoSupervisedFlowSequence():
    ...
    def load(self, idx: int, relative_to_idx: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "is_ground_points": np.zeros(len(relative_global_frame_pc),
                                         dtype=bool),
